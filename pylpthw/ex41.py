...
def princess_lives_here():
	print "You see  a beautiful Princess with a shiny crow.",
	...
	if eat_it == "eat it":
		...
		print "The last thing you see is here munching on your torso. Yum!"
		return 'death'

	elif eat_it == "make her eat it":
		print "The Princess screams as you cram the cake in the mouth."
...
def gold_koi_pond():
	...
	print "You walk close and see a massive fin pke out."
	...
	if feed_it == "feed it":
		print "The koi jump up, and rather than eating the cake, eats your arm."
		print "You fall in  and the Koi shrugs than eats you."
		print "You are the popped out sometime later."
		return 'death'
		...
		print "The Koi grimaces, then trashes around for a second."
...
def bear_with_sword():
	...
	if give_it == "give it":
		...
		print '"Where the hel did that come from?" You say.'
...
def big_iron_gate():
	...
	if open_it == 'open it':
		...
		print "Oh, but then the bear comes with katana and stabs you."
